...
void SNF(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &P, std::vector<std::vector<int_t>> &Q)
{
	int_t N = A.size();
	int_t M = N;
...
void type2rowM(std::vector<std::vector<int_t>> &A, int_t addTo, int_t addFrom, int_t mult)
{
	int_t M = A.size();
	int_t m;
	for (m = 0; m < M; ++m)
...
// transpose of this operation is flipping addTo and addFrom
// inverse of this operation is changing mult to -1*mult
void type2rowN(std::vector<std::vector<int_t>> &A, int_t addTo, int_t addFrom, int_t mult)
{
	int_t N = A.size();
	int_t n;
	for (n = 0; n < N; ++n)
...
void type1col(std::vector<std::vector<int_t>> &A, int_t len, int_t col, int_t unit)
{
	if (unit != 1 && unit != -1)
	{
...
void type2col(std::vector<std::vector<int_t>> &A, int_t len, int_t addTo, int_t addFrom, int_t mult)
{
	int_t i;
	for (i = 0; i < len; ++i)
	{
...
void type3col(std::vector<std::vector<int_t>> &A, int_t len, int_t col1, int_t col2)
{
	int_t i;
	for (i = 0; i < len; ++i)
	{
...
void updateFinishedRows(std::vector<std::vector<int_t>> &A, std::vector<int_t> &finishedRows)
{
	int_t N = A.size();
	int_t M = N;
	int_t tempCount, m, n;
...
void updateFinishedColumns(std::vector<std::vector<int_t>> &A, std::vector<int_t> &finishedColumns)
{
	int_t N = A.size();
	int_t M = N;
	int_t tempCount, m, n;
...
void findLeastEntry(std::vector<std::vector<int_t>> &A, std::vector<int_t> &finishedRows,
					std::vector<int_t> &finishedColumns, int_t *tempN, int_t *tempM, int_t *finished)
{
	int_t N = A.size();
	int_t M = N;
	int_t m, n;
...
int_t dividesRowAndCol(std::vector<std::vector<int_t>> &A, int_t tempN, int_t tempM)
{
	int_t N = A.size();
	int_t M = N;
	int_t m, n;
...
void findLeastEntry2(std::vector<std::vector<int_t>> &A, int_t *tempN, int_t *tempM, int_t counter)
{
	int_t N = A.size();
	int_t M = N;
	int_t m, n;
...
void rowOperations1(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &P,
					std::vector<std::vector<int_t>> &Pinv, int_t n, int_t unit)
{
	type1rowM(A, n, unit);
	type1rowN(P, n, unit);
...
void rowOperations2(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &P,
					std::vector<std::vector<int_t>> &Pinv, int_t n, int_t tempN, int_t tempMult)
{
...
void rowOperations3(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &P,
					std::vector<std::vector<int_t>> &Pinv, int_t row1, int_t row2)
{
	if (row1 != row2)
	{
...
void columnOperations2(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &Q,
					   std::vector<std::vector<int_t>> &Qinv, int_t m, int_t tempM, int_t tempMult)
{
	int_t N = A.size();
	int_t M = N;
...
// combines all type 2 column operations int_to one function
void columnOperations3(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &Q,
					   std::vector<std::vector<int_t>> &Qinv, int_t col1, int_t col2)
{
	int_t N = A.size();
	int_t M = N;
	if (col1 != col2)
...
void smithTransform(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &P,
					std::vector<std::vector<int_t>> &Pinv, std::vector<std::vector<int_t>> &Q,
...
void makeAllDiagsPositive(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &P,
...
void orderDiagonals(std::vector<std::vector<int_t>> &A, std::vector<std::vector<int_t>> &P,
					std::vector<std::vector<int_t>> &Pinv, std::vector<std::vector<int_t>> &Q,
